...
detail in \autoref{sec:server-setup} and discuss alternatives in \todo{Add ref}.
...
disclose their name. We use Yivi to request and verify these attributes. \todo{Stuk aanpassen over verschillen rooms}
...
\todo{Add a section about the code and github repo}
