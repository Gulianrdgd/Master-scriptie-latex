...
If we look at video conferencing from a architectural perspective, we see that there are multiple conferencing
...
client in an Iframe. This prohibits the global clients javascript from interacting with the hub client.
...
In the code base, there is a clear distinction between the global client and the hub client. They
