...
are separate code bases, which are built and deployed separately. These clients are isolated from each other, however
there is a way to communicate between the global client and the hub client. This is used only to let the hub client
know certain settings which are stored in the global client. For example, whether the user prefers a light or dark
theme.
