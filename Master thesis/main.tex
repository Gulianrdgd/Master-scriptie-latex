...
\begin{document}
    ...
    some testers\TODO{Misschien daadwerkelijk handig}. We will also have to look at the current privacy
...
% Misschien een sectie waar we vertellen dat je nu met AI heel veel dingen kan faken?
    ...
    matrix intends to do moving forward, as they have speicified in a presentation \TODO{find presentation}. The
